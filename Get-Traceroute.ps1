...
.EXAMPLE
PS C:\> Get-Traceroute.ps1 2606:4700::6810:84e5
IPv6 traceroute. The filename will replace colon characters with dashes.
#>
...
[CmdletBinding()]
  param(
    ...
    [Parameter(ValueFromPipeline)]
    [Alias("f")]
    [String]$Filename = "Traceroute_$Target" -replace (':','-')
